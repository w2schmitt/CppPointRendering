...
LDLIBSOPTIONS=-lglut -lAntTweakBar -lGL -lGLU -lGLEW
...
${OBJECTDIR}/camera/float3.o: camera/float3.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/camera/float3.o camera/float3.cpp

${OBJECTDIR}/util.o: util.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/util.o util.cpp

${OBJECTDIR}/camera/Camera.o: camera/Camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/camera
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/camera/Camera.o camera/Camera.cpp
...
${OBJECTDIR}/mesh.o: mesh.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/mesh.o mesh.cpp

${OBJECTDIR}/matrix.o: matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/matrix.o matrix.cpp

${OBJECTDIR}/camera/opengl.o: camera/opengl.cpp 
	${MKDIR} -p ${OBJECTDIR}/camera
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/camera/opengl.o camera/opengl.cpp

${OBJECTDIR}/callbacks.o: callbacks.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/callbacks.o callbacks.cpp
